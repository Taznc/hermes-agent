...
| `HERMES_KANBAN_DB_HOME` | the kanban home that pin was computed under (a probe/test that re-declares a different `HERMES_HOME` gets its own sandbox instead of the live board) |
