...
KANBAN_GUIDANCE = (
    ...
    "inert. Ready review children use the same packet contract and keep repair executable ahead of unfinished review. "
    "Block only on an external prerequisite.\n"
    "6. **Flag collision hotspots; don't pile on.** If your change keeps colliding with sibling branches in one file, "
