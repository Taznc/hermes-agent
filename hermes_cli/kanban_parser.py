...
_SPECS = [
    ...
    _cmd("dispatch", [
        ...
        _arg("--consent-post-drain", action="store_true",
             help="Attended only: give explicit consent to this board's queued post-drain "
                  "restart/reboot so it may fire once drained (asks for typed confirmation)"),
