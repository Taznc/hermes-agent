...
def _dispatched_payload(
    dispatch: dict, goals: List[str], child_agents: List[Any], live_paths: List[str],
...
def _dispatch_background(batch: _Batch) -> str:
    ...
    if dispatch.get("status") == "dispatched":
        return json.dumps(
            _dispatched_payload(dispatch, goals, child_agents, batch.live_paths, batch.task_routes), ensure_ascii=False)
